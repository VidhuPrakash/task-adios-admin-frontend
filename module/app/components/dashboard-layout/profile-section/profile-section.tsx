...
const ProfileSection = () => {
  return (
    <div className="relative overflow-hidden group cursor-pointer border  flex items-center gap-2 rounded-[8px] p-4 transition-transform duration-300 ease-in-out hover:scale-[1.03] hover:shadow-lg min-h-16">
