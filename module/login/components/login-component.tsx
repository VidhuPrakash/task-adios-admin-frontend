...
const LoginComponent = () => {
  return (
    <div className="lg:overflow-hidden flex flex-col p-[48px] h-screen">
      ...
      <div className="lg:px-[100px] w-full lg:flex items-start justify-between gap-[100px] min-h-screen">
